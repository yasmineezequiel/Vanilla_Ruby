...
# Command:
# $ ri Array
# We can see some ruby documentation for Array and all available methods:
...
#   compact, compact!, concat, count, cycle, dclone, delete, delete_at,
#   delete_if, difference, dig, drop, drop_while, each, each_index,
#   empty?, eql?, fetch, fill, filter, filter!, find_index, first,
#   flatten, flatten!, hash, include?, index, initialize_copy, insert,
#   inspect, join, keep_if, last, length, map, map!, max, min, none?,
#   one?, pack, permutation, pop, prepend, product, push, rassoc, reject,
#   reject!, repeated_combination, repeated_permutation, replace, reverse,
#   reverse!, reverse_each, rindex, rotate, rotate!, sample, select,
#   select!, shelljoin, shift, shuffle, shuffle!, size, slice, slice!,
#   sort, sort!, sort_by!, sum, take, take_while, to_a, to_ary, to_h,
#   to_s, transpose, union, uniq, uniq!, unshift, values_at, zip, |
